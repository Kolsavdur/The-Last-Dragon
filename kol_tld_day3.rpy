...
Lg tannoyed "I will admit, there were some strange things stored there. One such thing was a recipe for pancakes, of all things. Another example was-{w=1.0}{nw}"
...
menu:
    "Clean water would be far more useful right now.":
        ...
        m "I entered the water treatment plant with a feeling of uncertainty, since anything could go wrong at any point during my search."
        ...
        Lg tannoyed flip "Not that they could do much, anyway."
    ...
    "Getting more food available will help us right now.":
        ...
        Lg tannoyed "That is, until we start to experience water problems."
        ...
        Lg tannoyed flip "It really makes me wonder how much tech is actually still functional in this city."
        ...
        Lg tannoyed flip "...or a zap, in this case."
...
Lg tannoyed flip "So, you’re telling me that the people here who look like raiders {i}aren’t{/i} raiders?"
...
Lg tannoyed "Yeah, now that I’ve thought about it, you haven’t said anything yet."
...
menu:
    "We desperately need any extra help we can get.":
        ...
        show logan tannoyed at Position(xpos = 0.75) with dissolve
        $ renpy.pause (3.5)
