...
if kol_tld_wtpchosen == True:
    ...
    Lg annoyed flip "Not that I could think of. I’ll have to try and think about what our next plans are."
    ...
    Lg annoyed flip "The rain caused by this storm will definitely damage a lot of infrastructure here in the city, considering that most buildings here are very much {i}not{/i} waterproof."
    ...
    Lg annoyed flip "Lucky you, then."
    ...
    Lg annoyed "Maybe more, if we start rationing when our current food supplies run out."
