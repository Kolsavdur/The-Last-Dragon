...
menu:
    ...
    "No, it’s alright.":
        ...
        if kol_tld_secretending == True: #Secret Ending Time!
            ...
            m "This time, Remy wasted no time in getting to the city as possible, as he flew a direct course to my house at astonishing speeds."
            ...
            Lg tthinking dk"This ought to be quite the challenge."
            Lg tsmiling dk "I'm in."

            $ renpy.pause (1.0)
            scene black with dissolveslow
            play music "mx/starlight_kol.ogg" fadein 1.0

            jump tld_Credits

            $ kol_tld_endinga = True
...
Lg thinking "Wait? You didn't notice?"
...
menu:
    "Yeah. No need to make a comprehensive list.":
        ...
        Lg thinking "Or so they taught me at university."
...
Lg thinking "I wonder how dragon fire would affect the meat."
...
menu:
    ...
    "Veggie skewers":
        ...
        Lg thinking "Wait, I always thought that you ate meat. Since when did that change?"
...
Lg thinking "Now that I think about it, these pork chops remind me of something that I used to do back in my university days."
Ry "How so?"
...
show logan tthinking dk with dissolve
...
Lg tthinking dk "The fact that he went to the portal, however, just throws a spanner in the works."
...
#THE FEELS OF THIS AAAAAAAAAAAAAAAAAAASFPOHEPWAINDFPIGHZXHKHQIOIHZVFOUVHZCG[OIUATRRETGKFG
...
#Why did I decide to copy Saunders' code instead of just going back to the original credits scene? I don't know!
