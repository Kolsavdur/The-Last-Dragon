...
Lg annoyed "Last I checked, the outer walls were being repaired."
...
if kol_tld_wtpchosen == True:
    ...
    Lg annoyed flip "Well, since you asked, we might as well check on that."
    ...
    Lg annoyed "As for Remy, I’m not entirely sure. I don’t think that he’d be able to do something complicated like reconstruction."
    ...
    Lg annoyed flip "If I recall, he said that he went somewhere to retrieve something that he needed to make an estimation on some supports for the roof."
    ...
    Lg annoyed "It does make me wonder, though. Do your scales protect you from getting wet, or do you get soaked like the rest of us?"
    ...
    Lg annoyed flip "At least they aren’t {i}entirely{/i} clueless."
    ...
    Lg annoyed flip "Now, let’s see if it’s..."

    play sound "fx/magnetzap_kol.wav"
    $ renpy.pause (4.0)

    Lg smiling flip "Yep. Magnetic and still responsive."
    Lg annoyed flip "And it seems that it should fit right about here, although I’m not sure what effect that might have on the adjacent parts that are more resistant to the effects of electromagnetic induction."
    Lg "Hmmmmm..."
    ...
    Lg annoyed "However, if we manage to get the systems online, we should be able to grow crops in the old greenhouse upstairs. Luckily, Martin carried some spare seeds with him which we could use, because for some reason he was carrying those."
    ...
    Lg annoyed "Now, what does the magical PDA of almost all human knowledge say..."
    ...
    Lg annoyed "Either that, or from what I can gather from Remy, your cooking is just horrid."
    ...
    menu:
        "The food was similar to the food here, though.":
            ...
            Lg annoyed "What an interesting concept, then."
