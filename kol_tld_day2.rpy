...
Lg annoyed "Not that it matters, as all my work has mostly gone to waste."
...
Lg annoyed flip "Is that so? Guess I overestimated everything your kind achieved, then."
...
menu:
    "Well, I suppose it wouldn’t hurt.":
        ...
        Lg annoyed flip "Impressive. Even the wires are all connected in the same way as ours. It’s like these things were made with human technology in mind."
        ...
        Lg annoyed "Luckily I didn’t need to do any repairs on the card, as it survived the solar flare. How on earth this could survive, but not nanobots in someone’s bloodstream, will baffle me until I die."
