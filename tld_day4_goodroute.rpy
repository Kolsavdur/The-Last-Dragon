...
if kol_tld_wtpchosen == True:
    ...
    Mt "At least me and everybody else is safe, to a certain degree."
    ...
    Lg thinking flip "If I recall, he said that he went somewhere to retrieve something that he needed to make an estimatation on some supports for the roof."
    ...
    Mt shocked "Oh! [player_name] and Remy is here!"
